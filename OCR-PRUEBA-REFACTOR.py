...
def index():
        resultado = {
            'Response': "BIENVENIDOS A MI API OCR"
        }
...
def realizar_ocr():
    try:
      ...
      # Realizar el recorte de la imagen en partes más pequeñas
        ...
        tesseract_dir = os.path.join(os.path.dirname(os.path.abspath(_file_)), 'tesseract-ocr', 'tesseract.exe')
...
# Configura la ruta al ejecutable de Tesseract
        ...
        texto_imagen1 = pytesseract.image_to_string(parte_cortada1,lang='eng')
        texto_imagen2 = pytesseract.image_to_string(parte_cortada2, lang='eng')
        texto_imagen3 = pytesseract.image_to_string(parte_cortada3, lang='eng')
        texto_imagen4 = pytesseract.image_to_string(parte_cortada4, lang='eng')
        texto_imagen5 = pytesseract.image_to_string(parte_cortada5, lang='eng')
        texto_imagen6 = pytesseract.image_to_string(parte_cortada6, lang='eng')
        texto_imagen7 = pytesseract.image_to_string(parte_cortada7, lang='eng')
        texto_imagen8 = pytesseract.image_to_string(parte_cortada8, lang='eng')
        texto_imagen9 = pytesseract.image_to_string(parte_cortada9, lang='eng')
        texto_imagen10 = pytesseract.image_to_string(parte_cortada10, lang='eng')
        texto_imagen11 = pytesseract.image_to_string(parte_cortada11, lang='eng')
